...
#define SERVO_ON              ebmSetOutput(0,13,1) // 
#define SERVO_OFF             ebmSetOutput(0,13,0) // 
...
#define SERVO_STARTED        ebmGetOutput(0,13)     // Servo motor STARTED
#define SERVO_STOPPED        (!ebmGetOutput(0,13))  // Servo
